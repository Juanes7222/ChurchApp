...
from routes import admin_router, auth_router, miembos_router, observaciones_router, grupos_router, dashboard_router, pos_router
import os
import logging
...
app.include_router(miembos_router, prefix="/api")
